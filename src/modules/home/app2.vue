    ...
    <header class="header header-transparent header-waterfall ui-header">
      ...
      <ul class="nav nav-list pull-right">
        <template v-if="categories">
          <li v-for="category in categories" v-bind:key="category.id" v-if="category.sub_category.length != 0 "
            ...
            <ul class="dropdown-menu dropdown-menu-right">
              <li v-for="sub in category.sub_category" v-bind:key="sub.id">
      ...
      <div class="menu-scroll">
        <div class="menu-content">
          ...
          <ul class="nav">
            ...
            <template v-if="categories">
              <li v-for="(category,index) in categories" v-bind:key="category.id" v-if="category.sub_category.length != 0">
